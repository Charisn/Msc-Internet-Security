...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->error) {
        $conn->rollback();
        echo "Failed to insert data: (" . $conn->errno . ") " . $conn->error;
    } else {
                            ...
                            <div class="form-container">
                                <div class="form-inside-container">
                                    ...
                                    <div class="course-group">
                                        <div class="form-group course-content">
                                            <label>Course Content</label>
                                            <div id="course_content">
                                                <div class="content_row">
                                                    <input type="text" name="tab_name[]" class="custom-input"
                                                        placeholder="Course Name">
                                                    <textarea name="tab_content[]" class="custom-textarea"
                                                        placeholder="Course Content"></textarea>
                                                    <button type="button"
                                                        class="custom-btn remove_content_btn">Remove</button>
                                                </div>
                                            </div>
                                            <button type="button" class="custom-btn add_content_btn">Add More
                                                Content</button>
                                        </div>
                                    ...
                                    <div class="form-group modules">
                                        ...
                                        <div id="course_modules">
                                            <div class="module_row">
                                                <input type="text" name="module_name[]" class="custom-input"
                                                    placeholder="Module Name">
                                                <input type="number" name="module_credits[]" class="custom-input"
                                                    placeholder="Module Credits">
                                                <button type="button"
                                                    class="custom-btn remove_module_btn">Remove</button>
                                            </div>
                                        </div>
                                        <button type="button" class="custom-btn add_module_btn">Add More
                                            Modules</button>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).ready(function () {
        $(".add_content_btn").click(function () {
            var contentRow = `<div class="content_row">
                ...
                <button type="button" class="custom-btn remove_content_btn">Remove</button>
            </div>`;
    ...
    // Same as the script above, this function also adds more inputs for modules. Key difference is the regex that prevents user from typing anything other than number.
    $(document).ready(function () {
        $(".add_module_btn").click(function () {
            var moduleRow = `<div class="module_row">
                ...
                <button type="button" class="custom-btn remove_module_btn">Remove</button>
            </div>`;
